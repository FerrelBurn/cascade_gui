...
class RequirementCrosswalk extends Component {
    ...
    matchRequirements() {
        ...
        axios.get("http://208.188.184.42:3005/seed_relationships")
            .then((response) => {
    ...
    remove(index, i, uuid1, uuid2) {
        ...
        axios.get("http://208.188.184.42:3005/remove_rel/" + uuid1 + "/" + uuid2)
            .then((response) => {
    ...
    acceptRelationship(index, i, uuid1, uuid2) {
        ...
        axios.get("http://208.188.184.42:3005/accept_rel/" + uuid1 + "/" + uuid2)
            .then((response) => {
